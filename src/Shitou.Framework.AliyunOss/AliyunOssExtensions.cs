...
namespace Shitou.Framework.AliyunOss
{
    public static class AliyunOssExtensions
    {
        ...
        /// <returns></returns>
        public static IConfigurationBuilder AddAliyunOssFile(this IConfigurationBuilder builder, string path, bool optional, bool reloadOnChange)
        {
            builder.AddJsonFile(path, optional, reloadOnChange);
            IConfigurationRoot configuration = builder.Build();
            AliyunOssConfig.Instance = configuration.GetSection("AliyunOssConfig").Get<AliyunOssConfig>();
            return builder;
        }
        ...
        /// <returns></returns>
        public static IServiceCollection AddAliyunOss(this IServiceCollection services)
        {
